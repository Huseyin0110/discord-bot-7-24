...
module.exports.run = async (bot, message, args, guild) => {
    ...
    if(!tavsiye) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription('Tavsiyeni girmedin! Doğru kullanım: `t!tavsiye <tavsiyeniz>`').setColor("RED"));
    ...
    message.channel.sendEmbed(new Discord.RichEmbed().setColor("GREEN").setDescription('Tavsiyeniz başarıyla [destek sunucumuza](DESTEK SUNUCUNUN LİNKİ KARDEŞİM) gönderildi! :white_check_mark:'));
})};
