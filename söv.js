exports.run = async (client, msg, args) => {
  let kufur=[
	...
	"ananın amına ev sinema sistemi sokar sesi sonuna kadar açar titreşiminden ananı orgazm ettiririm.",
	"götüne domates sokar salça yapana kadar sikerim seni",
	"ananın amına windows 7 kurar error verene kadar sikerim orrosbu çocu",
 ...
 color: Math.floor(Math.random() * (0xFFFFFF + 1)),
 description: (':no_entry_sign:Oglem Bah Sen Yapımcım Hüseyin Abinemi Küfür Ediyon Seni Döverim ha!')
}})
 ...
 description: (`:no_entry_sign: Beni mi kandırcan orospu çocuğu ?`)
  ...
  msg.channel.send({embed: {
 color: Math.floor(Math.random() * (0xFFFFFF + 1)),
 description: (`${member} ${kufur[Math.floor(Math.random() * 20)]}.`)
}})
  }
