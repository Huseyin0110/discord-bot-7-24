...
exports.run = (client, message, args) => {
    ...
    if (!game) return message.reply('Lütfen Steamde Olan Bir Oyunun Adını Yazın. Örnek: `+oyunbilgi portal 2`')
...
exports.help = {
  name: 'oyunbilgi',
  description: 'Steamda Olan Butun Oyunların Bilgilerini Gosterebilir.',
  usage: 'oyunbilgi'
};