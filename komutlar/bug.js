...
if (reason.length < 1) return message.channel.send(':no_entry: Lütfen **botun sahibine** iletmemi istediğiniz mesajı girin; `t!tavsiye Lütfen daha fazla özellik gelsin!`');
